...
NICHES_KEYWORDS = {
    "Фотограф": [
        ...
        # Контент и соцсети
        r"\bконтент[- ]?мейкер\b", r"\bпортфолио\b", r"\bпрайс\b", r"\breels\b", r"\bрилсы\b",
    ...
    "Сдача недвижимости": [
        ...
        r"\bпосуточно\b", r"\bдолгосрочная аренда\b", r"\bкраткосрочная аренда\b",
        ...
        r"(стоимость|цена|сколько стоит|бюджет).{0,50}(аренд|снять|квартир|дом|вилл|апартамент)",
        r"\bсниму\b", r"\bснимаю\b", r"\bснимаем\b", r"\bарендую\b", r"\bарендуем\b",
