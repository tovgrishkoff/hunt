...
async def test_anna():
    """Тест отправки кода для Anna Truncher"""
    phone = ACCOUNT["phone"]
    api_id = ACCOUNT["api_id"]
    api_hash = ACCOUNT["api_hash"]
    session_name = "test_anna_truncher"
    
    print(f"\n{'='*80}")
    print(f"🔍 Тест: Anna Truncher ({phone})")
    print(f"{'='*80}")
    ...
    try:
        ...
        try:
            ...
            if answer == 'y':
                ...
                print("   Выберите аккаунт 1 (Anna Truncher)")
            else:
                print("\n⚠️ Код не пришел")
                print("   Рекомендации:")
...
if __name__ == "__main__":
    print("🧪 Тест отправки кода для Anna Truncher")
    print("="*80)
